  ...
  <div className="bg-white rounded-2xl shadow-lg p-10 border border-blue-100">
    <div className="mb-8">
      ...
      <h1 className="text-4xl font-extrabold text-blue-800 mb-2 flex items-center gap-2">
        <svg className="w-7 h-7 text-yellow-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><circle cx="12" cy="7" r="4"></circle><path d="M9 17v-2a4 4 0 018 0v2"></path></svg>
        {job.title}
      </h1>
